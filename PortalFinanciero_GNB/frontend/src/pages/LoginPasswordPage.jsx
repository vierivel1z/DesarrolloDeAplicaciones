  ...
  return (
    <div className="gnb-login-screen">
      ...
      <div className="gnb-login-top-bar">
        <Link to="/login" className="gnb-login-back-btn">
          <ArrowLeft size={16} /> Regresar a Login con Token
        </Link>
      </div>
            ...
            <div style={{ marginTop: '10px', marginBottom: '15px' }}>
              {isAdmin ? (
                <span style={{ fontSize: '11.5px', color: 'rgba(255, 255, 255, 0.75)' }}>
                  Acceso de Empleado (Core): roles permitidos <strong>maker01, checker1_01, checker2_01, superadmin01</strong> · clave <strong>demo1234</strong>
                </span>
              ) : (
                <span style={{ fontSize: '11.5px', color: 'rgba(255, 255, 255, 0.75)' }}>
